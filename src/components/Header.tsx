      ...
      <div className="flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3 min-w-fit">
          <img 
            src="/icon.png" 
            alt="56K Llama" 
            className="w-9 h-9 rounded-xl shadow-lg shadow-amber-500/20 border border-amber-500/40 object-cover shrink-0" 
          />
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="px-2 py-0.2 text-[9px] font-bold rounded bg-amber-500/20 text-amber-300 border border-amber-500/40 uppercase font-mono">
                v2.0
              </span>
            </div>
